...
def drive_reconstruction():
    ...
    # TODO: uncomment this for running on a single parameter setting
    if single_snippet:
        if iterative_recons:
            params_dict = {}
        ...
        if show_z_scores_plot:
            for this_index in select_kernel_indexes:
                plot_utils.plot_kernel_spike_profile(sp_times[sp_indexes == this_index], all_convs[this_index],
                                                     ...
                                                     gamma_vals[this_index],
                                                     other_fns=[gamma_vals[this_index] - all_convs[this_index][
                                                                                         :len(gamma_vals[this_index])],
                                                                this_signal],
                                                     other_titles=['gamma minus conv', 'input signal'],
